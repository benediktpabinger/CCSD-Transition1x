...
generated by running nudged elastic band (NEB) searches, where earlier
datasets held equilibrium structures and their surroundings. It demonstrated that a PaiNN model trained on these
...
transition states had not been tested systematically, because the
published benchmarks score the models against restricted references,
as the rest of this chapter shows; the Preface gives the account.
...
restricted structure is scored as a success.
...
Whether the OMol25 approach is enough has not been measured.
