...
Transition1x to predict the cheap level (Section~\ref{sec:mace-training}) --- the model whose level of theory we upgrade. It
...
\begin{itemize}
  \item cheap-level DFT transition state, as stored in Transition1x, to
    expensive-level DFT transition state: 0.007\,\AA{}. This is how far
...
This is also why MACE looks right at high MR: the cheap level
