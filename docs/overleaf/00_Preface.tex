...
different structures. The reason turned out to be that their labels
are unrestricted, so the models search for transition states with
broken spin symmetry, while the references we worked with were
optimised with restricted spin symmetry. Whether the models can find
