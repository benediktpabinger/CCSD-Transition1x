...
\midrule
Transition1x & $\omega$B97X-D3/6-31G(d) & restricted & $\omega$B97X-D3/6-31G(d) & restricted \\
OMol25       & $\omega$B97X-D3/6-31G(d) & restricted & $\omega$B97M-V/def2-TZVPD & unrestricted \\
\bottomrule
\end{tabular}
\end{table}

From here on, the Transition1x level is \mbox{$\omega$B97X-D3/6-31G(d)}
...
the change of level from \mbox{$\omega$B97X-D3/6-31G(d)} to
...
\paragraph{Alternative explanations.} It is not a convergence artefact: the
force error is measured at fixed geometries, with no optimisation
involved. It is not a matter of breaking depth: the error does not
correlate with it. It is not an energy problem: the energies at the
delivered structures are within chemical accuracy for almost all of
them.
