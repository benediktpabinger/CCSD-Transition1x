...
high-MR tier, at equal multireference character, the broken-symmetry
structures are still worse than the closed-shell ones, 0.127 against
0.082 in residual force and 0.025 against 0.018 in force error, and
their training points lie three times further off the transition
state (1.70 against 0.58). That remaining factor of about 1.5 is what
the training data explain; the pooled factor of 2.5 between the two
groups contains both effects.
