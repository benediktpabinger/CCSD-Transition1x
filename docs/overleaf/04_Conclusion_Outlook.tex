...
character the correction overshoots. Chapter~\ref{ch:mr} showed that
at mid MR the restricted reference is sound, so the overshoot there
is the head's error, while at high MR the restricted reference is
