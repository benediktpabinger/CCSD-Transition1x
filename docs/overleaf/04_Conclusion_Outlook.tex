...
degrades the closed-shell structures too. At equal multireference
character the broken-symmetry structures remain worse by a factor of
about 1.5, and that part is what the training data explain.
