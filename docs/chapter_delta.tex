...
\begin{figure}[htbp]
  ...
  levels of theory; both models start at the $\omega$B97X/6-31G(d) level.
  ...
  $E^{\omega\text{B97M}} - E^{\omega\text{B97X}}$. The head error is
  small in every tier; the baseline error grows with multireference
  character and dominates at high MR. Bare MACE sits near the reference
  at high MR only because its baseline error happens to cancel the
  level gap.}
