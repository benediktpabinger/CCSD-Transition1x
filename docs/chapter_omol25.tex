...
\begin{figure}[t]
  ...
  Cartesian components. DFT at the OMol25 level on the unrestricted surface
  (Sec.~\ref{sec:dft}); colours mark the two groups of
...
\begin{figure}[t]
  ...
  at the OMol25 level on the unrestricted surface
...
\begin{figure}[t]
  ...
  OMol25 level on the unrestricted surface (Sec.~\ref{sec:dft}).}
  \label{fig:barrier}
\end{figure}
