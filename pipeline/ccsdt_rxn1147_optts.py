"""
CCSD(T)/def2-TZVP single points for rxn1147 at the CASSCF OptTS geometry.

Geometries:
  TS  = ~/nevpt2_optts_results/rxn1147_avas/ts_casscf_opt.xyz  (CASSCF-optimised)
  R/P = ~/orca_neb_results/rxn1147/reactant.xyz / product.xyz  (ORCA NEB endpoints)

NEVPT2(opt) = 2114 meV (forward barrier, for comparison)

Run on cluster: python3 pipeline/ccsdt_rxn1147_optts.py
"""
