...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/energy/s242862/logs/mace_small_%j.log
...
NAME=mace_t1x_small_p${PATIENCE}
...
echo "Starting MACE small: channels=128, L=2, patience=${PATIENCE}"
