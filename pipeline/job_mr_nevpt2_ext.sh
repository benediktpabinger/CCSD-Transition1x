...
#SBATCH --mem=120GB
#SBATCH --array=0-19
#SBATCH --output=/home/energy/s242862/logs/mr_nevpt2_ext_%A_%a.log

# NEVPT2/AVAS on R, TS, P for 20 extended benchmark reactions.
# Bottom 10 (lowest NFOD) + 10 evenly spaced through the middle.
# AVAS run at TS; MOs projected to R and P.
