...
#SBATCH --time=2:00:00
#SBATCH --array=0-29
#SBATCH --output=/home/energy/s242862/logs/mace_bare_neb_%A_%a.log

# Bare MACE NEB (no delta correction head) — ablation baseline for the
# MACE+delta NEB results. Results go to mace_bare_neb_results/.
