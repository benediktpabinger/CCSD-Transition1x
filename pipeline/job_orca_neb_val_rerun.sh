#!/bin/bash
#SBATCH --job-name=orca_neb_val_rerun
#SBATCH --partition=xeon24el8
#SBATCH --time=2-02:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --output=/home/energy/s242862/logs/orca_neb_val_rerun_%A_%a.log
#SBATCH --array=0-224

# Rerun unconverged val reactions:
#   < 70 steps: resume from last neb.db images
#   >= 70 steps: restart with linear interpolation from relaxed endpoints
# Usage: sbatch /home/energy/s242862/pipeline/job_orca_neb_val_rerun.sh
