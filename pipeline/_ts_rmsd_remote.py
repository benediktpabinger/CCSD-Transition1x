...
print(f'{"rxn":<10} {"MR":<5} {"ORCA-eSEN":>10} {"ORCA-UMA":>10} {"ORCA-MACEd":>12} {"eSEN-UMA":>10} {"eSEN-MACEd":>12}')
print('-' * 72)
...
for rxn in CONVERGED:
    ...
    maced = load(f'{BASE}/mace_delta_neb_results/{rxn}/transition_state.xyz')
    print(f'{rxn:<10} {MR[rxn]:<5} {rs(orca,esen):>10} {rs(orca,uma):>10} {rs(orca,maced):>12} {rs(esen,uma):>10} {rs(esen,maced):>12}')
