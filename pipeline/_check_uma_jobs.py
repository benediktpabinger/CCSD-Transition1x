...
for rxn in REACTIONS:
    base = f'/home/energy/s242862/uma_neb_results/{rxn}'
...
if converged or running:
    ...
    print(run(f'tail -5 /home/energy/s242862/uma_neb_results/{sample}/neb.log 2>/dev/null || echo no log yet'))
    print()
    print(f'=== last 5 lines of SLURM log task 0 ===')
    print(run(f'tail -10 /home/energy/s242862/logs/uma_neb_10438881_0.log 2>/dev/null || echo no log yet'))
