#!/bin/bash
#SBATCH --job-name=uma_m_neb_next
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-14
#SBATCH --output=/home/energy/s242862/logs/uma_m_neb_next_%A_%a.log

# UMA-M NEB for the next-HIGH MR benchmark extension (FOD ranks 12-26,
