"""
CCSD(T)/def2-TZVP single points for rxn8827 at the CASSCF OptTS geometry.

Geometries:
  TS  = ~/nevpt2_optts_results/rxn8827_avas/ts_casscf_opt.xyz  (CASSCF-optimised)
  R/P = ~/orca_neb_results/rxn8827/reactant.xyz / product.xyz  (ORCA NEB endpoints)

NEVPT2(opt) = 4003 meV (forward barrier, for comparison)

Run on cluster: python3 pipeline/ccsdt_rxn8827_optts.py
"""
