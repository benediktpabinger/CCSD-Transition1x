...
sftp = ssh.open_sftp()
sftp.put(f'{LOCAL}\\_ts_rmsd_uma_sm_remote.py', f'{REMOTE}/_ts_rmsd_uma_sm_remote.py')
sftp.close()

_, out, err = ssh.exec_command(
    'module load Python/3.13.5-GCCcore-14.3.0 && python3 /home/energy/s242862/pipeline/_ts_rmsd_uma_sm_remote.py'
)
