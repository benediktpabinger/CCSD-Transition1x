...
#SBATCH --mem=48G
#SBATCH --output=/home/energy/s242862/orca_hinge25/slurm_%A_%a.out
#SBATCH --error=/home/energy/s242862/orca_hinge25/slurm_%A_%a.err

# Der Hinge-Test auf OMol25-Niveau.
#
...
#
# Schreibt nur nach orca_hinge25/. orca_neb_omol25/ wird nur gelesen.
...
TASKFILE=${TASKFILE:-$H/hinge25_tasks.txt}
