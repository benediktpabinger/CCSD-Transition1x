...
# wB97M-V/def2-TZVP SPs on 10 uniformly sampled T1x geometries per reaction.
# 500 training reactions, one node per reaction, 10 SPs run serially.
...
python3 /home/energy/s242862/pipeline/delta/train_delta_sp.py ${RXN} --n-threads 8
